...
<html>
    <head>
        <title>Cetak Data Guru Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <h2>Sistem Informasi SMP Negeri 1 Kisaran </h2>
                        ...
                        <hr>
                        <h3>DATA GURU BULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <tr>
                            ...
                            $sql = "SELECT * FROM guru WHERE month(tgl_lahir)= '$ambilbln' And year(tgl_lahir)= '$ambilthn' ";
