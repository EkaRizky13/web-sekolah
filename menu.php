...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand">Sistem Informasi SMP Negeri 1 Kisaran</a>
        </div>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="?page=murid&actions=tampil">Murid</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="?page=guru&actions=report">Laporan Guru</a></li>
						            <li><a href="?page=murid&actions=report">Laporan Murid</a></li>
                    </ul>
                </li>
